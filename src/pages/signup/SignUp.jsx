...
const SignUp = () => {
  return (
    <div className="lg:flex">
        <div className="flex flex-col h-screen bg-white md:pb-7 md:h-auto lg:pb-36">
            ...
            <form>
                <div className="flex flex-col items-center justify-center gap-5 md:gap-13 md:items-start md:justify-start md:pl-20">
                    ...
                    <div className="flex gap-3 items-center w-[80%] pt-3">
                        <input type="checkbox" className="w-4 h-4 bg-white rounded shrink-0"/>
        ...
        <div className="bg-[#1D253D] hidden lg:block lg:w-[55%]">
            <div className="flex items-center justify-end pt-16 pr-16 lg:gap-24">
                <a href="#"><p className="font-sans text-base font-normal text-white">Acceuil</p></a>
                <a href="#"><p className="font-sans text-base font-normal text-white">En savoir plus</p></a>
            </div>
            <div className="relative min-h-screen">
                <img src={"../../../public/Mesa de trabajo 1@4x 2.png"} alt="image" className="absolute top-0 left-0 -mt-2 -ml-16"/>
                <img src={"../../../public/Artboard 1df@4x 3.png"} alt="image" className="absolute bottom-0 -mb-40 transform -translate-x-1/2 left-1/2"/>
            </div>
        </div>
    </div>
  )
